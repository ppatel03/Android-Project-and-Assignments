...
public class BusDataComputation {
    ...
    public BusDataComputation(Context context){
	...
	public void sortAccordingToCriteria(String sortType, List<Bus> selectedBuses){
		if(sortType != null){
			switch(sortType){
			case "Cost": Collections.sort(selectedBuses, new BusTripCostComparator()); break;
			case "Ratings":Collections.sort(selectedBuses, new BusRatingsComparator()); break;
			case "Time" : Collections.sort(selectedBuses, new BusTripTimeComparator()); break;
			}
		}
