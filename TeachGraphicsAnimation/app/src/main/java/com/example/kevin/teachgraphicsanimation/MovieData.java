...
public class MovieData {
    ...
    public MovieData(){
		...
		moviesList.add(createPlanet("Avatar", R.drawable.avatar, description, year, length, rating, director, stars, url));
		year = "1997";
		length = "194 min";
		rating = 7.7;
		director = "James Cameron" ;
		...
		moviesList.add(createPlanet("Titanic", R.drawable.titanic, description, year, length, rating, director, stars, url));
		year = "2012";
		length = "143 min";
		rating = 8.2;
		...
		description = "Nick Fury of S.H.I.E.L.D. assembles a team of superheroes to save the planet from Loki and his army.";
        moviesList.add(createPlanet("The Avengers", R.drawable.avengers, description, year, length, rating, director, stars, url));
		year = "2008";
		length = "152 min";
		rating = 9.0;
        ...
        moviesList.add(createPlanet("The Dark Knight", R.drawable.dark_knight, description, year, length, rating, director, stars, url));
		year = "1999";
		length = "136 min";
		rating = 6.6;
        ...
        moviesList.add(createPlanet("Star Wars I", R.drawable.star_wars1, description, year, length, rating, director, stars, url));
		year = "1977";
		length = "121 min";
		rating = 8.7;
		director = "George Lucas" ;
        ...
        moviesList.add(createPlanet("Star Wars IV ", R.drawable.star_wars4, description, year, length, rating, director, stars, url));
		year = "2012";
		length = "165 min";
		rating = 8.6;
		director = "Christopher Nolan" ;
        ...
        moviesList.add(createPlanet("The Dark Knight Rises", R.drawable.dark_knight_rises, description, year, length, rating, director, stars, url));
		year = "2004";
		length = "93 min";
		rating = 7.3;
        ...
        moviesList.add(createPlanet("Shrek 2", R.drawable.shrek2, description, year, length, rating, director, stars, url));
		year = "1982";
		length = "115 min";
		rating = 7.9;
        ...
        moviesList.add(createPlanet("E.T. the Extra-Terrestrial", R.drawable.et, description, year, length, rating, director, stars, url));
		year = "2013";
		length = "146 min";
		rating = 7.8;
		...
		moviesList.add(createPlanet("The Hunger Games: Catching Fire", R.drawable.hunger_games, description, year, length, rating, director, stars, url));
        ...
        moviesList.add(createPlanet("Pirates of the Caribbean: Dead Man's Chest", R.drawable.pirates, description, year, length, rating, director, stars, url));
		year = "1994";
		length = "89 min";
		rating = 8.5;
        ...
        moviesList.add(createPlanet("The Lion King", R.drawable.lion, description, year, length, rating, director, stars, url));
		year = "2010";
		length = "103 min";
		rating = 8.4;
        ...
        moviesList.add(createPlanet("Toy Story 3", R.drawable.toy3, description, year, length, rating, director, stars, url));
		year = "2013";
		length = "130 min";
		rating = 7.4;
        ...
        moviesList.add(createPlanet("Iron Man 3", R.drawable.ironman3, description, year, length, rating, director, stars, url));
		year = "2012";
		length = "142 min";
		rating = 7.3;
		director = "Gary Ross" ;
        ...
        moviesList.add(createPlanet("The Hunger Games", R.drawable.hunger_games1, description, year, length, rating, director, stars, url));
		year = "2002";
		length = "121 min";
		rating = 7.3;
		director = "Sam Raimi" ;
        ...
        moviesList.add(createPlanet("Spider-Man", R.drawable.spiderman, description, year, length, rating, director, stars, url));
		year = "1993";
		length = "127 min";
		rating = 8.0;
		director = "Steven Spielberg" ;
        ...
        moviesList.add(createPlanet("Jurassic Park", R.drawable.jurassicpark, description, year, length, rating, director, stars, url));
		year = "2009";
		length = "150 min";
		rating = 6.0;
        ...
        moviesList.add(createPlanet("Transformers: Revenge of the Fallen", R.drawable.transformers, description, year, length, rating, director, stars, url));
		year = "2013";
		length = "102 min";
		rating = 7.9;
        ...
        moviesList.add(createPlanet("Frozen", R.drawable.frozen, description, year, length, rating, director, stars, url));
		year = "2011";
		length = "130 min";
		rating = 8.1;
        ...
        moviesList.add(createPlanet("Harry Potter and the Deathly Hallows: Part 2", R.drawable.harry2, description, year, length, rating, director, stars, url));
		//#21-30
		year = "2003";
		length = "100 min";
		rating = 8.2;
        ...
        moviesList.add(createPlanet("Finding Nemo", R.drawable.nemo, description, year, length, rating, director, stars, url));
		year = "2005";
		length = "140 min";
		rating = 7.7;
		director = "George Lucas" ;
        ...
        moviesList.add(createPlanet("Star Wars III", R.drawable.star_wars3, description, year, length, rating, director, stars, url));
		year = "2003";
		length = "201 min";
		rating = 8.9;
        ...
        moviesList.add(createPlanet("The Lord of the Rings: The Return of the King", R.drawable.rings, description, year, length, rating, director, stars, url));
		year = "2004";
		length = "127 min";
		rating = 7.4;
		director = "Sam Raimi" ;
        ...
        moviesList.add(createPlanet("Spider-Man 2", R.drawable.spiderman2, description, year, length, rating, director, stars, url));
		year = "2013";
		length = "98 min";
		rating = 7.6;
        ...
        moviesList.add(createPlanet("Despicable Me 2", R.drawable.despicable2, description, year, length, rating, director, stars, url));
		year = "2011";
		length = "154 min";
		rating = 6.4;
		director = "Michael Bay" ;
        ...
        moviesList.add(createPlanet("Transformers: Dark of the Moon", R.drawable.transformers2, description, year, length, rating, director, stars, url));
		year = "2002";
		length = "179 min";
		rating = 8.8;
		director = "Peter Jackson" ;
        ...
        moviesList.add(createPlanet("The Lord of the Rings: The Two Towers", R.drawable.rings2, description, year, length, rating, director, stars, url));
		year = "2007";
		length = "139 min";
		rating = 6.3;
		director = "Sam Raimi" ;
        ...
        moviesList.add(createPlanet("Spider-Man 3", R.drawable.spiderman3, description, year, length, rating, director, stars, url));
		year = "2010";
		length = "108 min";
		rating = 6.5;
		director = "Tim Burton" ;
        ...
        moviesList.add(createPlanet("Alice in Wonderland", R.drawable.alice, description, year, length, rating, director, stars, url));
		year = "1994";
		length = "142 min";
		rating = 8.8;
        ...
        moviesList.add(createPlanet("Forrest Gump", R.drawable.forrest_gump, description, year, length, rating, director, stars, url));		
    }


    private HashMap createPlanet(String name, int image, String description, String year, String length, double rating, String director, String stars, String url) {
