 ...
 */
public class MyUpdateBusLocationDetailAsyncTask extends AsyncTask<String,Integer,String> {
    ...
    public MyUpdateBusLocationDetailAsyncTask(ProgressBar progressBar, Context context, TextView textView) {
    ...
    protected void onPostExecute(String result) {
        if(GenericConstants.SUCCESS_STATUS.equalsIgnoreCase(result)){
            ...
            textView.setText("Your Bus Location Data is Saved Successfully");
            SystemClock.sleep(1000);
            publishProgress(100);
