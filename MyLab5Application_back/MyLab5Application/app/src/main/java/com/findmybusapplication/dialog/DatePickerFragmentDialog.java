package com.findmybusapplication.dialog;
...
public class DatePickerFragmentDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        mDate = (Date) getArguments().getSerializable(ArgumentConstants.ARGS_DATE);
        ...
        datePicker.init(year, month, day, new DatePicker.OnDateChangedListener() {
            public void onDateChanged(DatePicker view, int year, int month, int day) {
                ...
                getArguments().putSerializable(ArgumentConstants.ARGS_DATE, mDate);
            }
        });
                        ...
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                if (getTargetFragment() != null) {
                                    Intent i = new Intent();
                                    i.putExtra(ArgumentConstants.ARGS_DATE, mDate);
    ...
    public static DatePickerFragmentDialog newInstance(Date d) {
        ...
        args.putSerializable(ArgumentConstants.ARGS_DATE, d);
