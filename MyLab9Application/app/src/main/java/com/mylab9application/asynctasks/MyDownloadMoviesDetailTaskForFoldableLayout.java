...
/**
 * Created by prashant on 4/18/2015.
 */
public class MyDownloadMoviesDetailTaskForFoldableLayout extends AsyncTask<String,Void,HashMap>{


        private  final WeakReference<FoldableLayoutFragment.OnListItemSelectedListener> onListItemSelectedListenerWeakReference;
        private final int position;

        public MyDownloadMoviesDetailTaskForFoldableLayout(FoldableLayoutFragment.OnListItemSelectedListener onListItemSelectedListenerReference,
        int position) {
            this.position = position;
            this.onListItemSelectedListenerWeakReference = new
                    WeakReference<FoldableLayoutFragment.OnListItemSelectedListener>(onListItemSelectedListenerReference);
        ...
        FoldableLayoutFragment.OnListItemSelectedListener onListItemSelectedListenerReference =
