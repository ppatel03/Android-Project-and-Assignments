package com.mylab9application.movie;

import android.content.Context;
import android.util.Log;

import com.mylab9application.utility.MyUtility;
...
public class MovieDataJson implements Serializable {
    public static final String FILE_SERVER = "http://www.example.com/";
    public static final String PATH_FOR_ALL_MOVIES_DATA = "movies/";
    public static final String PATH_FOR_MOVIE_DETAIL = "id/";
    public static final String PATH_FOR_RATING = "rating/";
    ...
    public void loadMoviesFromJsonUrl(String path)  {
        try{
            ...
            Log.i("movie JSON DATS : ",jsonMoviesDataString);
    ...
    public HashMap loadDetailMovieDataFromJsonUrl(String path)  {
        ...
        try{
            ...
            for (int i = 0; i < moviesJsonArray.length(); i++) {
                ...
                if (movieJsonObj != null) {
                    name = (String) movieJsonObj.get("name");
                    year = (String) (movieJsonObj.get("year")).toString();
