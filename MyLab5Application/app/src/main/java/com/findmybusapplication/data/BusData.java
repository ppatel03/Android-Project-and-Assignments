...
public class BusData implements Serializable {
    ...
    private List<Map<String,?>> waitForMeRequestList = new ArrayList<Map<String,?>>();

    public List<Map<String, ?>> getWaitForMeRequestList() {
        return waitForMeRequestList;
    }

    public void setWaitForMeRequestList(List<Map<String, ?>> waitForMeRequestList) {
        this.waitForMeRequestList = waitForMeRequestList;
    }
