...
public  class CoverPageFragment extends Fragment implements View.OnClickListener{
    ...
    public void attachListenersToButtons(View rootView){
        ...
        ImageView viewPagerButton = (ImageView)rootView.findViewById(R.id.viewPagerActivityButton);
        viewPagerButton.setOnClickListener(this);

        ImageView recyclerViewButton = (ImageView )rootView.findViewById(R.id.recyclerViewActivityButton);
